...
class IndicesConfig:
    ...
    def from_env(cls) -> "IndicesConfig":
        ...
        return cls(
            ...
            heartbeat_seconds=env_int("INDICES_HEARTBEAT_SECONDS", env_int("HEARTBEAT_SECONDS", 3600)),
            ...
            telegram_heartbeat_minutes=max(0, env_int("INDICES_TELEGRAM_HEARTBEAT_MINUTES", 60)),
