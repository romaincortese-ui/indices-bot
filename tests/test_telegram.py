...
def test_telegram_messages_are_clear() -> None:
    ...
    position = IndexPosition("SPX500", "SPX500_USD", "LONG", "TEST", 2, 2, 5000, 4975, 5050, datetime.now(timezone.utc), "US", "T1", {"estimated_margin_used": 200.0, "account_currency": "GBP"})
    opened = order_opened_message(position)
    closed = trade_closed_message({"symbol": "SPX500", "instrument": "SPX500_USD", "direction": "LONG", "strategy": "TEST", "order_id": "T1", "realized_pl": 3.25, "margin_used": 200.0, "pnl_pct": 1.625, "account_currency": "GBP", "sync_reason": "not_in_oanda_open_positions"}, reason="not_in_oanda_open_positions")
